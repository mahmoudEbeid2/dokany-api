// src/validation/seller.validation.js (or wherever your validation schemas are)
...
export const sellerRegisterSchema = z.object({
  ...
  // Will Change After integration of Stripe
  payout_method: z.string()
    .min(1, "Payout method is required")
    .optional(),
    // Example: .refine(method => ['paypal', 'bank_transfer'].includes(method), "Invalid payout method")
});
